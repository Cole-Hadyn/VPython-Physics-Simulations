...
sf = 1e-4 # scale factor for arrows
	...
	# Creating the dipole of particles
...
ob1.E1 = (oofpez * charge_1.q / mag(r1)**2 * hat(r1) )
print("ob1.E1 = ", ob1.E1)
...
ob1.E = Enet1
attach_arrow(ob1, "E", scale = sf)   # Displaying E-field at observation point
...
while t < 100:
  ...
  test_charge.E1 = (oofpez * charge_1.q / mag(r3)**2) * hat(r3)
  test_charge.E2 = (oofpez * charge_2.q / mag(r4)**2) * hat(r4)
  Enet2 = (test_charge.E1 + test_charge.E2)
  F = test_charge.q * (Enet2)
  v = test_charge.p + (F * dt)
  test_charge.pos = test_charge.pos + ((v/test_charge.m)*dt)
  t = t + dt
